...
X(bool, s_SDF_CPUEnable) \
X(unsigned int, s_hashNumBucketsC) \
X(unsigned int, s_hashNumSDFBlocksC) \
X(unsigned int, s_hashMaxCollisionLinkedListSizeC) \
X(float, s_SDFVoxelSizeC) \
X(float, s_SDFMarchingCubeThreshFactorC) \
X(float, s_SDFTruncationC) \
X(float, s_SDFTruncationScaleC) \
X(float, s_SDFMaxIntegrationDistanceC) \
X(unsigned int, s_SDFIntegrationWeightSampleC) \
X(unsigned int, s_SDFIntegrationWeightMaxC)  \
X(unsigned int, s_sensorColorWidth)  \
X(unsigned int, s_sensorColorHeight)  \
X(unsigned int, s_sensorDepthWidth)  \
X(unsigned int, s_sensorDepthHeight)  \
X(float, s_depthScale)  \
X(unsigned int, s_frameRate)	\
X(bool, s_poseCameraEnabled)

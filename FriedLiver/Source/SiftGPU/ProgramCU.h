...
public:
	...
	static void GetOpenCVMatch(cv::cuda::PtrStepSz<int> gm1, cv::cuda::PtrStepSz<float> gm2, uint2* d_outKeyPointIndices, float* d_outMatchDistances, int* d_numMatches, uint2 keyPointOffset);
	static void GetOpenCVKnnMatch(cv::cuda::PtrStepSz<int2> gm1, cv::cuda::PtrStepSz<float2> gm2, uint2* d_outKeyPointIndices, float* d_outMatchDistances, int* d_numMatches, uint2 keyPointOffset);
};
